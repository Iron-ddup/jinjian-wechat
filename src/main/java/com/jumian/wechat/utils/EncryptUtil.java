...
public class EncryptUtil {// 算法名称
    ...
    public static String encryptedData(String encryptedData, String session_key, String iv) {
        byte[] sessionKeyBy = Base64.decode(session_key);
        byte[] encryptedDataBy = Base64.decode(encryptedData);
        byte[] ivBy = Base64.decode(iv);
        byte[] dec = EncryptUtil.decryptOfDiyIV(encryptedDataBy, sessionKeyBy, ivBy);
